...
>
> Diese Stufen gibt es, weil das die größten MTUs waren, die der seinerzeit übliche Kernel auf einem Pi 4 übertrug — nicht weil die Platine nicht mehr könnte. Der AudioLinux-LTS-Echtzeitkernel enthält inzwischen einen Patch, der derselben Hardware die vollen **9000** ermöglicht, ohne Bootloader- oder EEPROM-Änderung; die Leiter in Schritt 2 und 3 findet daher 9000, wo sie früher bei 3824 stehen blieb. Die kleineren Stufen bleiben dokumentiert, weil ein ungepatchter Kernel weiterhin dort stehen bleibt, wo er immer stehen blieb, und weil der neueste Nicht-LTS-Kernel im Angebot den Patch möglicherweise später übernimmt als der LTS-Kernel.
>
