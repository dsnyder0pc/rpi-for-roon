...
>
> Estos niveles existen porque eran las MTU más grandes que el kernel de la época transportaba en una Pi 4, no porque la placa no diera para más. El kernel de tiempo real LTS de AudioLinux incluye ahora un parche que da al mismo hardware los **9000** completos, sin cambiar el gestor de arranque ni la EEPROM, de modo que la escalera de los Pasos 2 y 3 encuentra 9000 donde antes se detenía en 3824. Los niveles menores siguen documentados porque un kernel sin parchear se detiene donde siempre lo hizo, y porque el kernel más reciente que no es LTS puede tardar más que el LTS en incorporar el parche.
>
